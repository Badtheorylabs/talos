...
export default class FileSystem extends PluginBase {
  ...
  async unload(agent: Talos) {
    agent.deregisterTool("fs/list");
    agent.deregisterTool("fs/read");
    agent.deregisterTool("fs/write");
    agent.deregisterTool("fs/delete");
    agent.deregisterTool("fs/copy");
    agent.deregisterTool("fs/move");
    agent.deregisterTool("fs/mkdir");
    agent.deregisterTool("fs/cd");
    agent.deregisterTool("fs/find-replace");
    agent.deregisterTool("fs/append");
  }
}
